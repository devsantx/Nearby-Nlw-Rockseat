          ...
          onBarcodeScanned={({ data }) => {
            if (data && !qrLock.current) {
              ...
              if (!data || typeof data !== 'string') {
                ...
                qrLock.current = false; // Libera o lock para permitir novas leituras
                return;
              }

              console.log('QR Code Data:', data); // Para depuração, verificar o conteúdo escaneado
